    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogPortal>
        ...
        <div
          ...
          className={cn(
            "fixed left-1/2 top-1/3 z-50 w-full max-w-[calc(100%-2rem)] -translate-x-1/2 gap-4 rounded-xl border border-border/60 bg-background p-4 shadow-xl",
            className
          )}
          role="dialog"
          aria-modal="true"
...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <CheckIcon className="ml-auto size-4 opacity-0 group-data-[selected=true]/command-item:opacity-100" />
    </div>
  )
}
