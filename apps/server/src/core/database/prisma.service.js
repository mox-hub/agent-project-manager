...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        function PrismaService_1(logger) {
            ...
            _this.logger = logger;
            _this.logger.setContext('Prisma');
            _this.$on('query', function (e) {
                _this.logger.debug('Prisma Query', {
                    query: e.query,
                    duration: e.duration,
                });
            });
            _this.$on('error', function (e) {
                var _a;
                _this.logger.error('Prisma Error', (_a = e === null || e === void 0 ? void 0 : e.stack) !== null && _a !== void 0 ? _a : String(e));
            });
            return _this;
        }
