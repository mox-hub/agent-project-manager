...
| 文档 | 描述 | 适用人群 |
|------|------|----------|
| [API 总览](./api/README.md) | API 统一约定、认证、错误格式、Swagger 使用 | 前后端开发者 |
...
**Swagger 文档访问：**
- Swagger UI: `http://localhost:4300/_api/docs`（开发环境）
- OpenAPI JSON: `http://localhost:4300/_api/openapi.json`
- 详细使用规范：[开发指南 - API 文档与 Swagger 规范](./development-guide.md#95-api-文档与-swagger-规范)
...
- [后端架构与实现](./architecture-backend.md) - 技术栈与模块设计（含 Swagger 配置）
- [开发指南](./development-guide.md) - 环境搭建与代码规范（含 Swagger 使用规范）
- [API 文档](./api/) - API 设计与实现（含 Swagger 说明）
